...
class Questionnaire(models.Model):
    ...
    def create_new(
        ...
        Raises:
            ``ValidationError``
        """
        configuration_code = configuration_code.replace('apps.', '')
        if updated is None:
...
class QuestionnaireLink(models.Model):
    ...
    from_questionnaire = models.ForeignKey(
        'Questionnaire', on_delete=models.CASCADE,related_name='from_questionnaire')
    from_status = models.IntegerField(choices=STATUSES)
    to_questionnaire = models.ForeignKey(
        'Questionnaire', on_delete=models.CASCADE,related_name='to_questionnaire')
