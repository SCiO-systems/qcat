...
from apps.configuration.models import Configuration, Value
from apps.configuration.utils import create_new_code
from apps.qcat.tests import TestCase
from apps.questionnaire.errors import QuestionnaireLockedException
from apps.questionnaire.models import Questionnaire, QuestionnaireLink, File, Lock, \
...
class QuestionnaireModelTest(TestCase):
    ...
    @patch('apps.configuration.utils.create_new_code')
    ...
    @patch('apps.questionnaire.models.get_language')
...
class FileModelTest(TestCase):
    ...
    @patch('apps.questionnaire.models.get_file_path')
    ...
    @patch('apps.questionnaire.models.get_url_by_file_name')
    @patch('apps.questionnaire.models.get_file_path')
    ...
    @patch('apps.questionnaire.models.create_thumbnails')
    @patch('apps.questionnaire.models.store_file')
