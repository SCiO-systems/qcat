...
from apps.questionnaire.utils import query_questionnaire
from apps.questionnaire.view_utils import get_pagination_parameters
...
class LogSubscriptionPreferencesMixin(UpdateView):
    ...
    def get_object(self, queryset=None):
        return get_object_or_404(self.model, user__id=str(self.request.user.id))
