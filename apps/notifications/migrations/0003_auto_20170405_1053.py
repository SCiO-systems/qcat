    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wanted_actions', models.CharField(verbose_name='Subscribed for following changes in the review status', max_length=255, blank=True, validators=[apps.notifications.validators.clean_wanted_actions])),
